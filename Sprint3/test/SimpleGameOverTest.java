...
public class SimpleGameOverTest {
    ...
    void TestRedWinHorizontalSimple() {
        ...
        gameConds.makePlayerMove(0, 0); //R
        red.setLetter('O');
        gameConds.makePlayerMove(1, 2); //B
        gameConds.makePlayerMove(0, 1); //R
        gameConds.makePlayerMove(1, 1); //B
        red.setLetter('S');
        gameConds.makePlayerMove(0, 2); //R
